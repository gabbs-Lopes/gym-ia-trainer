...
export default function ElevacaoPelvica() {
  return (
    <>
        ...
        <section className={styles.container}>
          ...
          <div className={styles.container__backGround}>
            <div className={styles.container__backGround_DivTitulo}>
              <h1 className={styles.container__backGround_titulo}>Elevação Pélvica</h1>
              <h1 className={styles.container__backGround_sombra}>Elevação Pélvica</h1>
            </div>
          </div>
          ...
          <table className={styles.passos__divPassos}>
            <tbody>
              <tr className={styles.passos__divPassos_div}>
                ...
                <td>Passo 1: Deite-se de costas, com os joelhos dobrados e os pés apoiados no chão, afastados na largura dos quadris.</td>
              </tr>

              <tr className={styles.passos__divPassos_div}>
                <td> <img src={numero2} alt="Passo 2" /> </td>
                <td>Passo 2: Contraindo os glúteos, levante os quadris em direção ao teto, mantendo os ombros e pés no chão.</td>
              </tr>

              <tr className={styles.passos__divPassos_div}>
                <td> <img src={numero3} alt="Passo 3" /> </td>
                <td>Passo 3: No ponto mais alto, forme uma linha reta dos ombros aos joelhos, contraindo os músculos dos glúteos.</td>
              </tr>

              <tr className={styles.passos__divPassos_div}>
                <td> <img src={numero4} alt="Passo 4" /> </td>
                <td>Passo 4: Baixe os quadris de volta ao chão de maneira controlada, sem tocar completamente.</td>
              </tr>

              <tr className={styles.passos__divPassos_div}>
                <td> <img src={numero5} alt="Passo 5" /> </td>
                <td>Passo 5: Na posição inicial, com os quadris no chão, antes de iniciar o próximo movimento.</td>
              </tr>

              <tr className={styles.passos__divPassos_div}>
                <td> <img src={numero6} alt="Passo 6" /> </td>
                <td>Passo 6: Mantenha o core contraído, respire normalmente e evite arquear a parte baixa das costas.</td>
              </tr>
            </tbody>
          </table>
