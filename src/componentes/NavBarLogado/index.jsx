...
export default function NavBarLogado({ perfil, clean, dark, admin, fixed, preto, exercicio, brancoCiano }) {
  ...
  return (
    <nav className={`
      ...
      <Logo brancoCiano={brancoCiano} clean={clean} admin={admin} />

      <div className={styles.menu}>
        <Menu blue preto={preto}/>
      </div>
    </nav>
  )
}
